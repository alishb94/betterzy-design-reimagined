	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				...
				'elevation-1': '0 1px 3px rgba(0, 0, 0, 0.05), 0 2px 8px rgba(0, 0, 0, 0.04)',
				'elevation-2': '0 3px 6px rgba(0, 0, 0, 0.04), 0 8px 16px rgba(0, 0, 0, 0.03)',
				'elevation-3': '0 10px 20px rgba(0, 0, 0, 0.04), 0 15px 25px rgba(0, 0, 0, 0.03)',
			...
			animation: {
				...
				'ripple': 'ripple 0.7s cubic-bezier(0, 0, 0.2, 1)'
			},
			backdropBlur: {
				xs: '2px',
			},
